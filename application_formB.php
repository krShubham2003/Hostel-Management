...
<div class="images">
<div class="photo">
			<img src="img/image 7.jpg" alt="photo" />
		</div>

		<div class="photo">
			<img src="img/image 8.jpg" alt="photo" />
		</div>
		
		<div class="photo">
			<img src="img/image6.jpg" alt="photo" />
		</div>
	</div><br>
<div class="mar">
<h3><u>Hostel B</u></h3>
<br>
<ul>
	<li><b>Location:</b> Central location with easy access to city hotspots.</li>
    <li><b>Infrastructure:</b> Cozy and comfortable dorm-style rooms for backpackers.</li>
    <li><b>Community: </b>Meet fellow travelers from around the globe.</li>
    <li><b>Amenities: </b>Communal kitchen, travel desk for tour arrangements.</li>
</ul>
</div>
