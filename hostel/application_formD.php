...
<div class="images">
<div class="photo">
			<img src="img/image 3.jpeg" alt="photo" />
		</div>
...
<br>
<ul> 
	<li><b>Location:</b>Serene location surrounded by nature and scenic views.</li>
    <li><b>Infrastructure:</b> Eco-friendly rooms with a focus on sustainability.</li>
    <li><b>Community:</b> Perfect for nature enthusiasts and hikers.</li>
    <li><b>Amenities:</b> Outdoor spaces, nature trails, and bonfire nights.</li>
</ul>
</div>
	...
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Application Form </h2>
			<div class="mail_grid_w3l">
				<form action="application_formD.php?id=<?php echo $_GET['id']?>" method="post">
					<div class="row">
