...
<div class="images">
<div class="photo">
			<img src="img/image 2.png" alt="photo" />
		</div>

		<div class="photo">
			<img src="img/image 1.png" alt="photo" />
		</div>
...
<br>
<ul>
	<li><b>Location:</b> Prime location near major universities and educational hubs.</li>
	<li><b>Infrastructure: </b>Modern facilities, study-friendly rooms, high-speed Wi-Fi.</li>
	<li><b>Community: </b>A supportive community of students from various disciplines.</li>
	<li><b>Amenities:</b> 24/7 security, common areas for socializing and study groups.</li>
</ul>
</div>
	...
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Application Form </h2>
			<div class="mail_grid_w3l">
				<form action="application_formA.php?id=<?php echo $_GET['id']?>" method="post">
					<div class="row">
